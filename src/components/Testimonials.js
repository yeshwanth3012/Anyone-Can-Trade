...
//       <div className="w-full py-4 overflow-hidden group">
//         <div className="hidden md:inline-flex animate-marquee items-start space-x-8 group-hover:[animation-play-state:paused]">
//           {testimonials.concat(testimonials).map((t, i) => (
//             <div
//               key={i}
//               className="relative flex-shrink-0 w-[21rem] min-h-[14rem] transition-all duration-300 z-0"
//             >
//               {/* Background card for shadow effect */}
//               <div className="absolute top-[-0.5rem] left-[-0.5rem] w-[22rem] min-h-[15rem] rounded-xl bg-gray-100 shadow-lg z-0 transition-all duration-300 hover:min-h-[21rem]"></div>
...
//           ))}
//         </div>
//         <div className="flex md:hidden overflow-x-auto no-scrollbar space-x-4 snap-x snap-mandatory">
//           {testimonials.map((t, i) => (
//             <div
//               key={i}
//               onClick={() => handleToggle(i)}
//               className={`relative flex-shrink-0 w-[18rem] rounded-xl shadow-lg bg-white px-4 py-4 snap-start cursor-pointer transition-all duration-300 ${
//                 expandedIndex === i ? "min-h-[22rem]" : "min-h-[14rem]"
//               }`}
//             >
//               <p
//                 className={`text-[1rem] italic text-[#474747] mt-4 transition-all duration-300 ${
//                   expandedIndex === i ? "line-clamp-none" : "line-clamp-5"
//                 }`}
//               >
//                 "{t.description}"
//               </p>
